...
public:
    ...
    */
    ...
    void InsertionSortDoublyLinked(int param, int order) {
        Node<T>* currentNode = head->next;
        while (currentNode) {
            Node<T>* nextNode = currentNode->next;
            Node<T>* searchNode = currentNode->previous;
        ...
        */
            ...
            while (input != "b") {
                ...
                if (input == "1") {
                    ...
                    //cin >> param;
                    //Student().SetParams(param);

                    cout << orderPrompt << endl;
                    cin >> order;

                    cout << "Sorting..." << endl;
                    sList.InsertionSortDoublyLinked(param, order);
                    cout << "Done." << endl;
                }
                else if (input == "2") {
                    cout << "Sorting..." << endl;
                    sList.bubbleSort();
                    //sList.BubbleSortDoublyLinked(param, order);
                    cout << "Done." << endl;
                }
                else if (input == "3") {
                    cout << "Sorting..." << endl;
